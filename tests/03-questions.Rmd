...
The can again be called either inline or in code chunks (inline seems simpler) within the R Markdown document, and it is imperative they be used as a pair, otherwise the resulting document will have missmatched HTML tags (*currently there's no sanity checking for this, it's up to the author!*).
...
This is a more complex solution. We'll reuse the plotting code from an earlier example to include a figure in the margin.
